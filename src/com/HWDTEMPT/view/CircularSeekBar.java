...
public class CircularSeekBar extends View {
	...
	private static final float DEFAULT_POINTER_RADIUS = 5f;// 7f圆圈的半�?
	private static final float DEFAULT_POINTER_HALO_WIDTH = 2f;// 6f圆圈颜色的粗�?
	private static final float DEFAULT_POINTER_HALO_BORDER_WIDTH = 2f;
	private static final float DEFAULT_CIRCLE_STROKE_WIDTH = 2f;// 5f大圈颜色的粗�?
	...
	private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.argb(255,
			0, 255, 0);
	private static final int DEFAULT_POINTER_COLOR = Color.argb(255, 255, 0,
			0);
